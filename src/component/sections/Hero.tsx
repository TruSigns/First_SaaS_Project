        ...
        <div className="relative flex flex-col items-center lg:text-left lg:py-8 lg:items-start lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2">
          ...
          <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
            <div className="flex sm:flex-row flex-col gap-5 w-full">
              <form
                action="#"
                className="py-1 pl-6 w-full pr-1 flex gal-3 items-center text-heading-3
              shadow-lg shadow-box-shadow border border-box-boarder bg-box-bg rounded-full ease-linear focus-within:bg-body focus-within:border-primary"
              >
